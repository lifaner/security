...
public class HttpClientUtils {
    ...
    protected String privateKey = "xyz1234590123456";//demo ywx（）
    protected String uid = "YWX00001";
...
//        File file = new File("F:\\workspace\\study\\demo\\src\\main\\resources\\log\\error.txt");
//        Set<String> devList = MyUtil.readLineFromFile(file);
//        File file = new File("F:\\workspace\\study\\demo\\src\\main\\resources\\log\\error.txt");
//        Set<String> devList = MyUtil.readLineFromFile(file);
        List<String> devList = Arrays.asList("217523100002203");
        Map<String, Object> map = null;
        Set<String> set = new HashSet<>();
        long start = System.currentTimeMillis();
        for(String devNo : devList){
            map = new HashMap<>();
            map.put("deviceNum", devNo);
            map.put("type", "3");
            String s1 = HttpClientUtils.doPost("http://api.feezu.cn/car/v1/forceReport", map);
            System.out.println("s1 = " + s1);
            map.put("type", "4");
            String s2 = HttpClientUtils.doPost("\"http://api.feezu.cn/car/v1/forceReport", map);
